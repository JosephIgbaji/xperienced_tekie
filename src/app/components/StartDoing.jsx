...
const StartDoing = () => {
  ...
  return (
    <div className="flex flex-col items-center md:flex-row justify-around py-10 bg-blue-950 w-full md:px-10 px-1 mt-5">
      <div className=" text-white text-center md:text-left md:w-1/2 px-5 mb-5 space-y-5">
      ...
      <div className="flex items-center justify-center rounded-lg bg-white p-5">
        <div className="flex flex-col items-center">
          <Image
            ...
            height={50}
          />
          <button className="flex items-center border-2 mb-5 border-blue-950 rounded-lg px-3 justify-between gap-4 hover:bg-blue-900 hover:text-white social-signin-btn">
            <svg
          ...
          <button className="flex items-center justify-between mb-5 gap-4 border-2 border-blue-950 rounded-lg px-1  hover:bg-blue-900 hover:text-white social-signin-btn">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
              width="30px"
